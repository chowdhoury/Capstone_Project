...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Shyamoli Poribahan","SB Super Deluxe","Hanif Enterprise","Green Line","Desh Travels","Ena Transport Pvt. Ltd. "};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
int main()
{
    ...
    system("cls");
    printf("\n\n\n");
   printf("====================================== WELCOME TO ONLINE BUS BOOKING SYSTEM SYSTEM ======================================\n\n\n");
...
getch();
    ...
    printf("\t----------------------------------------------------------------------------------------------------------\n");
    printf("\t\t\t Brought To You By Team Dear to Dream");
    getch();
    return 0;
}
...
printf("\n\t\t\t\tThe Total booking amount is %d TK.",200*booking);
itoa(seat1, str1, 10);
...
printf("=========================================== BUS CANCELATION SYSTEM ============================================\n\n\n");//for entering train number
bus();//for view the bus list
    ...
    do
{
	...
	{
	printf("  \n\n\n       WELCOME TO THE 'ONLINE BUS BOOKING' SYSTEM !!!! LOGIN IS SUCCESSFUL");
